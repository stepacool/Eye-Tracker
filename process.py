...
def init_cv():
    ...
    calib_picture = cv2.imread(os.path.join("img", "look_here.jpg"), 1)
    pointer = cv2.imread(os.path.join("img", "pointer.png"), 1)

    return faceDetect, eyeDetect, detector, calib_picture, pointer
